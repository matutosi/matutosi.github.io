...
const data = {
  ...
  plot_setting: '{"sys_c_names":["item","type","value","option","hide","delButton"]};{"sys_d_types":["text","select-one","text","text","checkbox","button"]};{"sys_selects":[null,["auto","button","checkbox","fixed","list","text","number"],null,null,null,null]};{"item":["Date","locLat","locLon","locAcc","delButton","updateButton","No","Identified","Sampled","Plot","Layer","Species","Cover","Memo"],"type":["auto","auto","auto","auto","button","button","auto","checkbox","checkbox","fixed","list","text","number","text"],"value":[" ","","","","","","","","","Plot_01","B1:B2:S1:S2:K","","",""],"option":["","","","","","","","","","","","","",""],"hide":[false,false,false,false,false,false,false,false,false,false,false,false,false,false],"delButton":["DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE"]}',
  // without "hide"
  plot_setting: '{"sys_c_names":["item","type","value","option","delButton"]};{"sys_d_types":["text","select-one","text","text","button"]};{"sys_selects":[null,["auto","button","checkbox","fixed","list","text","number"],null,null,null]};{"item":["Date","locLat","locLon","locAcc","delButton","updateButton","No","Identified","Sampled","Plot","Layer","Species","Cover","Memo"],"type":["auto","auto","auto","auto","button","button","auto","checkbox","checkbox","fixed","list","text","number","text"],"value":[" ","","","","","","","","","Plot_01","B1:B2:S1:S2:K","","",""],"delButton":["DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE"]}',
