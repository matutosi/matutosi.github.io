...
const data_test = {
  setting_plot: {
    ...
    biss_selects: [null,["auto","button","checkbox","fixed","list","text","number"],null,null],
    biss_inputs: {
      item:   ["PLOT","Invest","DELETE","DATE","NO","Loc","LOC_LAT","LOC_LON","LOC_ACC","UPDATE_TIME_GPS","Alt"],
      type:   ["fixed","fixed","button","auto","auto","text","auto","auto","auto","button","number"],
      value:  ["","fixed_text","","","","","","","","",""],
      DELETE: ["",""          ,"","","","","","","","",""]
    }
  },
  setting_occ: {
    ...
    biss_selects: [null,["auto","button","checkbox","fixed","list","text","number"],null,null],
    biss_inputs: {
      item: ["PLOT","DELETE" ,"DATE","NO"  ,"LOC_LAT","UPDATE_TIME_GPS","Species","Layer","Cover" ,"Sampled" ,"Memo"],
      type: ["fixed","button","auto","auto","auto"   ,"button"         ,"text"   ,"list" ,"number","checkbox","text"],
      value: ["","","","","","","","","","","","","","","","","","","","","","","",""],
      DELETE: ["","","","","","","","","","","","","","","","","","","","","","","",""]
    }
  },
