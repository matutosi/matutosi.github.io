...
const data = {
  ...
  setting_plot_default: '{"sys_c_names":["item","type","value","delButton"]};{"sys_d_types":["text","select-one","text","button"]};{"sys_selects":[null,["auto","button","checkbox","fixed","list","text","number"],null,null]};{"item":["Investigator","delButton","Date","No","Location","Plot","locLat","locLon","locAcc","updateButton","Altitude","Aspect","Inclination","B1Height","B2Height","S1Height","S2Height","K1Hieght","B1Cover","B2Cover","S1Cover","S21Cover","K1Cover","Memo"],"type":["text","button","auto","auto","text","text","auto","auto","auto","button","number","text","number","number","number","number","number","number","number","number","number","number","number","text"],"value":[" ","","","","","","","","","","","","","","","","","","","","","","",""],"delButton":["DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE"]}',
  //   setting_plot_default: '{"sys_c_names":["item","type","value","delButton"]};{"sys_d_types":["text","select-one","text","button"]};{"sys_selects":[null,["auto","button","checkbox","fixed","list","text","number"],null,null]};{"item":["Investigator","delButton","Date","No","Location","Plot","locLat","locLon","locAcc","Altitude","Aspect","Inclination","B1Height","B1Cover","B2Height","B2Cover","S1Height","S1Cover","S2Height","S21Cover","K1Hieght","K1Cover","Memo"],"type":["text","button","auto","auto","text","text","auto","auto","auto","number","text","number","number","number","number","number","number","number","number","number","number","number","text"],"value":[" ","","","","","","","","","","","","","","","","","","","","","",""],"delButton":["DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE"]}',
  ...
  //   setting_occ_default: '{"sys_c_names":["item","type","value","delButton"]};{"sys_d_types":["text","select-one","text","button"]};{"sys_selects":[null,["auto","button","checkbox","fixed","list","text","number"],null,null]};{"item":["Date","locLat","locLon","locAcc","delButton","updateButton","No","Identified","Sampled","Plot","Layer","Species","Cover","Memo"],"type":["auto","auto","auto","auto","button","button","auto","checkbox","checkbox","fixed","list","text","number","text"],"value":[" ","","","","","","","","","Plot_01","B1:B2:S1:S2:K","","",""],"delButton":["DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE","DELETE"]}',
  };
