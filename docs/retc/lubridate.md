...
日付固定(同じ月日)あるいは位置固定(○月の第○の○曜日)のときでの一年後の年月日を求めることを考える．
...
![](lubridate_files/figure-latex/unnamed-chunk-13-1.pdf)<!-- --> 
...
![](lubridate_files/figure-latex/unnamed-chunk-13-2.pdf)<!-- --> 
